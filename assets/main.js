...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('#container05', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
		onvisible.add('#image01', { style: 'zoom-out', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('#container09', { style: 'zoom-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
		onvisible.add('#container03', { style: 'zoom-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
		onvisible.add('#container01', { style: 'zoom-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
		onvisible.add('#container04', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
		onvisible.add('#container10', { style: 'zoom-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
		onvisible.add('#container16', { style: 'zoom-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
		onvisible.add('#container24', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
		onvisible.add('#container25', { style: 'zoom-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
		onvisible.add('#container26', { style: 'zoom-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
		onvisible.add('#container18', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
		onvisible.add('#container19', { style: 'zoom-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
		onvisible.add('#container07', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
		onvisible.add('#container15', { style: 'zoom-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
		onvisible.add('#container11', { style: 'zoom-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: true });
